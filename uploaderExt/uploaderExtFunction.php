...
<input type="file"   name="filer[]" multiple style="width:100%;text-overflow: ellipsis;"> 
    ...
    <label for="compress" style="color:#fff" style="margin-bottom:10px;font-size:11px;">Compress photo? <br> (resize 1080p)</label>
    <input type="checkbox" name="compress"></div>
...
$image = imagecreatefrompng($targetFilee);
} else {
return $targetFile;
}
if ($isAlpha) {
